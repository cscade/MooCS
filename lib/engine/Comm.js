...
BCS.Comm = {
	...
	read: function (section, key, callback) {
		...
		// Note: This method will return cached data if available. Cache is cleared on each write operaiton. To force a hard read, use hardRead() instead.
		...
		if (this.$responseCache[readable.target] !== undefined) {
