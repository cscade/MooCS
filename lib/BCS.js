/*	BCS.js
	...
	Provides the BCS namespace, and the BCS.Device instance generator.
*/
/*
...
BCS.Device = new Class({
	...
	hardRead: function (section, key, callback) {
		...
		delete this.$responseCache[BCS.$readables[section].target];
	...
	performRead: function (section, key, callback) {
		...
		var readable = BCS.$readables[section],
